...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li class="active">Download Global Report</li>
    </ol>
  </section>
        ...
        <div class="box box-primary">
          ...
          @endif
            <div class="box-header with-border">
                <h3><strong>Download Global report</strong></h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" id="frm-view-tutor-time" method="post"  action="{{ route('exportglobalreport') }}" enctype="multipart/form-data">
              {!! csrf_field() !!}
              <div class="box-body">
